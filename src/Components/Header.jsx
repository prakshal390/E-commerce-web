...
function Header() {
  ...
  let cartCount = 0;
  console.log("Starting cartCount:", cartCount); // Starting cartCount: 0  Header.jsx:12
  ...
  // ]
    ...
    for (let j = 0; j < product.sizes.length; j++) {
      // Size console
      console.log("Size Object:", product.sizes[j]); // Size Object: {size: 'S', qty: 1} Header.jsx:30
      console.log("Size Name:", product.sizes[j].size); // Size Name: S Header.jsx:31
      console.log("Size Qty:", product.sizes[j].qty); //Size Qty: 1 Header.jsx:32
  ...
  console.log("Final cartCount:", cartCount); //Final cartCount: 1 Header.jsx:39
    ...
    <header className="bg-black text-white">
      <div className="flex justify-between items-center p-4 max-w-7xl mx-auto">
        ...
        <nav className="hidden md:flex gap-8 text-lg">
          <a className="cursor-pointer hover:text-yellow-400" href="/">
            Home
          </a>
          <a className="cursor-pointer hover:text-yellow-400" href="/about">
            About
          </a>
          <a className="cursor-pointer hover:text-yellow-400" href="/products">
            Products
          </a>
          <a className="cursor-pointer hover:text-yellow-400" href="/contact">
            Contact
          </a>
          <a className="cursor-pointer hover:text-yellow-400" href="/collection">
            Collection
          </a>
        </nav>
      ...
      {menuOpen && (
        <div className="md:hidden flex flex-col items-center gap-6 pb-6">
          ...
          <a href="/cart" className="flex gap-2 items-center relative">
            <FaShoppingCart />
            Cart
